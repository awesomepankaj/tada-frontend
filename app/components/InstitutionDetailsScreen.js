...
export default class Institution extends React.Component {
  ...
  deleteInstitution() {
    this.props.dispatch(
      deleteInstitution(
        Number(this.props.params.clusterId),
        Number(this.props.params.institutionId),
      ),
    );
  }
  ...
  hasChildren() {
    if (this.props.boundariesByParentId[this.props.params.institutionId]) {
      return this.props.boundariesByParentId[this.props.params.institutionId].length > 0;
    } else return false;
  }
  ...
  Displayelement = props => {
    ...
    let hasClasses = this.hasChildren();
    ...
    return (
      <div>
        ...
        <CreateClass
          ...
          isOpen={this.props.modal.createClass}
          onCloseModal={this.toggleClassModal}
          save={this.saveClass}
        />
      </div>
    );
